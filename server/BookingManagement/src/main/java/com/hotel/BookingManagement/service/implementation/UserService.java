...
import com.hotel.BookingManagement.dto.UserDTO;
...
import com.hotel.BookingManagement.utils.JWTUtils;
...
public class UserService implements UserServiceInterface {
    ...
    public Response register(User user) {
        ...
        try {
            ...
            if (userRepository.existsByEmail(user.getEmail())) {
                throw new HotelException(user.getEmail() + "Already Exists");
            }
    ...
    public Response deleteUser(String userId) {
        ...
        try {
            userRepository.findById(Long.valueOf(userId)).orElseThrow(() -> new HotelException("User Not Found"));
    ...
    public Response getMyInfo(String email) {
        ...
        try {
            User user = userRepository.findByEmail(email).orElseThrow(() -> new HotelException("User Not Found"));
            UserDTO userDTO = Utils.mapUserEntityToUserDTO(user);
            response.setStatusCode(200);
            response.setMessage("successful");
            response.setUser(userDTO);
